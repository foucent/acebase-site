---
title: CDKeys | 充值卡与充值码价格参考
description: AceBase CDKeys —— Fortnite、Apex Legends、PlayStation Network、Nintendo、Steam、GoCash 等 7 种充值卡与充值码的逐档参考价（美元计价）。数据更新至 2026-09-21。
updated: 2026-09-24
hide:
  - title
  - toc
  ...
  <section class="ab-section">
    ...
    <article class="ab-card ab-card--brand ab-card--shop ab-card--fold ab-card--ec" id="fortnite-vbucks-card">
      <div class="ab-card__media">
        <img src="/assets/games/brand/fortnite-vbucks-card.png" alt="Fortnite 充值卡（V-Bucks）价格参考" fetchpriority="high" decoding="async">
      </div>
...
<div class="admonition note mg-games__note">
  ...
  <p><a href="/">首页</a> &middot; <a href="/tech/">电竞房与桌搭</a> &middot; <a href="/pc-components/">电脑组件</a> &middot; <a href="/gift-cards/">Gift Cards</a> &middot; <a href="/gallery/">画廊</a> &middot; <a href="/faq/">购买指南</a></p>
</div>
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "name": "充值卡与充值码价格参考",
      "description": "AceBase CDKeys，Fortnite、Apex Legends、PlayStation Network、Nintendo、Steam、GoCash 共 7 种充值卡与充值码的逐档参考价（美元计价）。数据更新至 2026-09-21。",
      "url": "https://acebase.cc/cdkeys/"
    },
    {
      "@type": "ItemList",
      "name": "充值卡与充值码价格参考",
      "numberOfItems": "7",
      "itemListElement": [
        { "@type": "Product", "position": 1, "name": "Fortnite 充值卡（V-Bucks）", "url": "https://acebase.cc/cdkeys/#fortnite-vbucks-card" },
        { "@type": "Product", "position": 2, "name": "Apex Legends 充值卡（Coins）", "url": "https://acebase.cc/cdkeys/#apex-legends-coins-card" },
        { "@type": "Product", "position": 3, "name": "PlayStation Network 充值卡（美国）", "url": "https://acebase.cc/cdkeys/#playstation-network-card-us" },
        { "@type": "Product", "position": 4, "name": "Nintendo Switch Online 会员资格", "url": "https://acebase.cc/cdkeys/#nintendo-switch-online" },
        { "@type": "Product", "position": 5, "name": "Nintendo eShop 充值卡（美国）", "url": "https://acebase.cc/cdkeys/#nintendo-eshop-card-us" },
        { "@type": "Product", "position": 6, "name": "Steam 钱包充值码（美国）", "url": "https://acebase.cc/cdkeys/#steam-wallet-card-us" },
        { "@type": "Product", "position": 7, "name": "GoCash 充值卡（全球）", "url": "https://acebase.cc/cdkeys/#gocash-card" }
      ]
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "CDKeys", "item": "https://acebase.cc/cdkeys/" }
      ]
    }
  ]
}

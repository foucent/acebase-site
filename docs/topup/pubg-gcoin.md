...
description: PUBG PC G-COIN 激活码 — BitTopup 布局 1:1 复刻
hide:
  - title
  - toc
---
...
<section class="bt-hero">
  ...
  <div>
    ...
    <p class="bt-hero__promo">💡 立即解锁 G-COIN — 助您赢在战术竞技场！（PC 版 CDK 邮件发货）</p>
  </div>
</section>
...
<div class="bt-main">
  ...
  <aside class="bt-checkout">
    <div class="bt-panel">
      <h2 class="bt-checkout__title">购买信息</h2>
...
<section class="bt-faq">
  <h2>PUBG G-COIN CDK 常见问题</h2>
  <p><strong>订单完成需要多长时间？</strong><br>通常几分钟内发码；如有延迟请联系客服。</p>
  <p><strong>和 PUBG Mobile UC 有什么区别？</strong><br>G-COIN CDK 用于 PC《绝地求生》；手机端请看 <a href="/topup/pubg-mobile-direct/">PUBG Mobile 直充</a>。</p>
</section>

...
<section class="bt-hero">
  ...
  <div>
    ...
    <p class="bt-hero__promo">💡 暗区突围手游 <strong>代充</strong> — 选好面额与 Player ID，点「我要代充」打开在线客服确认最新报价和库存。</p>
  </div>
</section>
...
<section class="bt-desc">
  ...
  <ol>
    <li>启动《暗区突围》并登录游戏</li>
    <li>点击右上角头像进入<strong>个人主页</strong></li>
    <li>复制用户名下方显示的<strong>角色 ID</strong></li>
  </ol>

  <h3>《暗区突围》充值小贴士</h3>
  <ul>
    <li>✅ 仔细核对 Player ID 是否正确</li>
    <li>✅ 请使用官方或授权渠道充值，保障账号安全</li>
    <li>✅ 确保支付应用为最新版本，以获得最快处理速度</li>
  </ul>
</section>
